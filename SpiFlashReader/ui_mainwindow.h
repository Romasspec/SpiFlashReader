...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        console->setGeometry(QRect(190, 40, 381, 111));
        ...
        progressBarWrite = new QProgressBar(centralWidget);
        progressBarWrite->setObjectName(QStringLiteral("progressBarWrite"));
        progressBarWrite->setGeometry(QRect(190, 190, 381, 23));
        progressBarWrite->setMaximum(100);
        progressBarWrite->setValue(0);
        ...
        spinBox->setGeometry(QRect(470, 220, 71, 22));
        spinBox->setMaximum(1000);
        spinBox->setValue(10);
        progressBar = new QProgressBar(centralWidget);
        progressBar->setObjectName(QStringLiteral("progressBar"));
        progressBar->setGeometry(QRect(190, 160, 381, 23));
        progressBar->setMaximum(100);
        progressBar->setValue(0);
        progressBar->setTextVisible(true);
        label_8 = new QLabel(centralWidget);
        label_8->setObjectName(QStringLiteral("label_8"));
        label_8->setGeometry(QRect(180, 160, 16, 16));
        label_9 = new QLabel(centralWidget);
        label_9->setObjectName(QStringLiteral("label_9"));
        label_9->setGeometry(QRect(180, 190, 16, 16));
        PlayFile = new QPushButton(centralWidget);
        PlayFile->setObjectName(QStringLiteral("PlayFile"));
        PlayFile->setGeometry(QRect(370, 220, 75, 23));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_9->setText(QApplication::translate("MainWindow", "w", 0));
        PlayFile->setText(QApplication::translate("MainWindow", "Play File", 0));
    } // retranslateUi
